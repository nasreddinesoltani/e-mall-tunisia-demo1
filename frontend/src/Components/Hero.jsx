  ...
  return (
    ...
    >
      ...
      <div className="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        >
          <img
            src="https://www.centives.net/S/wp-content/uploads/2013/12/122613_1224_TheHistoryO1.png"
            className="block w-full max-h-128"
            alt="..."
          />
        ...
        >
          <img
            src="https://pna.co.za/wp-content/uploads/2017/11/last-minute-shopping-tips-cover.jpg"
            className="block w-full max-h-128"
            alt="..."
          />
          <div className="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
        ...
        >
          <img
            src="https://faze.b-cdn.net/cms/wp-content/uploads/2014/04/guy-shopping-pov-t.jpg"
            className="block w-full max-h-128"
            alt="..."
          />
          <div className="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
